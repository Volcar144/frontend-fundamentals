---
title: Tailwind CSS
description: Master utility-first styling, responsive design, dark mode, and component patterns with Tailwind CSS.
---

Tailwind is a **utility-first CSS framework** — instead of writing custom CSS, you compose styles using small, single-purpose class names directly in your HTML/JSX.
...
Tailwind's scale: `1 = 4px`, `2 = 8px`, `4 = 16px`, `6 = 24px`, `8 = 32px`

```html
<!-- p = padding, m = margin, x/y/t/b/l/r = direction -->
...
```html
<!-- Semantic colour pairings -->
<div class="bg-blue-50   text-blue-800   border-blue-200">   <!-- Info -->
<div class="bg-green-50  text-green-800  border-green-200">  <!-- Success -->
<div class="bg-yellow-50 text-yellow-800 border-yellow-200"> <!-- Warning -->
<div class="bg-red-50    text-red-800    border-red-200">    <!-- Error -->
```
