---
title: TypeScript
description: Learn static typing, interfaces, generics, and utility types in TypeScript.
---

TypeScript is a **strongly typed superset of JavaScript** that compiles to plain JS. It catches bugs at compile time, powers IDE autocomplete, and scales to large codebases.
